...
export const PinContainer = ({ children, title, href, className, containerClassName }: {
  ...
  return (
    <a className={cn("relative group/pin z-50 cursor-pointer", containerClassName)}
      ...
      <div style={{ perspective: "1000px", transform: "rotateX(70deg) translateZ(0deg)" }}
        ...
        <div style={{ transform }}
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-[#070f1a] border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
    ...
    <div className="w-full h-full -mt-7 flex-none inset-0">
      <div className="absolute top-0 inset-x-0 flex justify-center">
        <a href={href} target="_blank" rel="noreferrer"
          className="relative flex space-x-2 items-center z-10 rounded-full bg-[#091d2e] py-0.5 px-4 ring-1 ring-white/10 pointer-events-auto">
